const quotes = [
    {
        input: "Try again. Fail again. Fail better.",
        output: { beckett: 1 }
    },{
        input: "When you come to a fork in the road, take it.",
        output: { berra: 1 }
    },{
        input: "We are all born mad. Some remain so.",
        output: { beckett: 1 }
    },{
        input: "You can observe a lot by just watching.",
        output: { berra: 1 }
    },{
        input: "You're on earth. There's no cure for that.",
        output: { beckett: 1 }
    },{
        input: "Never answer an anonymous letter.",
        output: { berra: 1 }
    },{
